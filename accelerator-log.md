...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=serpiko2&repo=tanzu-java-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=serpiko2&repo=tanzu-java-app'
